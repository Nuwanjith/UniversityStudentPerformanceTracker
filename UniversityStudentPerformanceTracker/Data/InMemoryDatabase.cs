...
public static class InMemoryDatabase
{
    ...
    private static string studySessionsFilePath = "Data/studySessions.xml";
    private static string breaksFilePath = "Data/breaks.xml";
    ...
    {
        Users = _xmlStorageService.LoadData<User>(usersFilePath);
